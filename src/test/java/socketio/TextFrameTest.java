...
public class TextFrameTest {
  ...
  public void when_no_namespace_eventFrame_includes_only_event_and_data() {
    String actual = TextFrame.getInstance().eventFrame("", "event", "data");
  ...
  public void when_a_namespace_eventFrame_includes_the_namespace() {
    String actual = TextFrame.getInstance().eventFrame("namespace", "event", "data");
  ...
  public void when_no_namespace_connectFrame_includes_only_connect() {
    String actual = TextFrame.getInstance().connectFrame("");
    String expected = "40";
    assertEquals(expected, actual);
  }
  ...
  public void when_a_namespace_connectFrame_includes_the_namespace() {
    String actual = TextFrame.getInstance().connectFrame("namespace");
  ...
  public void when_no_namespace_disconnectFrame_includes_only_disconnect() {
    String actual = TextFrame.getInstance().disconnectFrame("");
    String expected = "41";
    assertEquals(expected, actual);
  }
  ...
  public void when_a_namespace_disconnectFrame_includes_the_namespace() {
    String actual = TextFrame.getInstance().disconnectFrame("namespace");
  ...
  public void when_a_frame_has_3_arguments() {
    String actual = TextFrame.getInstance().eventFrame("namespace", "event", "data", "more data");
  ...
  public void when_a_frame_has_a_json_it_does_not_quote_the_json() {
    String actual = TextFrame.getInstance().eventFrame("namespace", "event", "data", "{\"id\": \"42\"}");
